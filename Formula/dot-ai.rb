class DotAi < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/vfarcic/dot-ai-cli/releases/download/1.2.1/dot-ai-darwin-arm64"
      sha256 "bc0ff499c8525a8b6b8721afa6922c4620c0a671b350f96addbe74dcc5323da8"
    else
      url "https://github.com/vfarcic/dot-ai-cli/releases/download/1.2.1/dot-ai-darwin-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/vfarcic/dot-ai-cli/releases/download/1.2.1/dot-ai-linux-arm64"
      sha256 "22312c13d8e9c4ede633c8fc58a352c7599b0ddd5937a10556259ee11477e7ba"
    else
      url "https://github.com/vfarcic/dot-ai-cli/releases/download/1.2.1/dot-ai-linux-amd64"
